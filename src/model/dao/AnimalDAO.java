...
public class AnimalDAO {
    public void Create(Animal fun){        
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO animal (nome_ani, raca_ani, porte_ani, dataNasc_ani, idade_ani, Cliente_id_ani) VALUES (?, ?, ?, ?, ?, ?)");
            ...
            stmt.setString(4, fun.getIdade_ani());
            stmt.setInt(5, fun.getCliente_id());
    ...
    public void Update(Animal fun){        
        ...
        try {
            stmt = con.prepareStatement("UPDATE animal SET nome_ani = ?, raca_ani = ?, porte_ani = ?, dataNasc_ani = ?, idade_ani = ?, Cliente_id_ani = ? WHERE id_ani = ?");
            stmt.setString(1, fun.getNome_ani());
            stmt.setString(2, fun.getRaca_ani());
            stmt.setString(3, fun.getPorte_ani());
            stmt.setString(4, fun.getDataNasc_ani());
    ...
    public List read(){
        ...
        try {           
            ...
            while(rs.next()){
                ...
                func.setCliente_id(rs.getInt("Cliente_id_ani"));
